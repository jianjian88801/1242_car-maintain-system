...
<div class="easyui-layout" fit="true" border="false">
    ...
    <script type="text/javascript">      	
	   ...
	   $("#dg").edatagrid({
	 		url:"${pageContext.request.contextPath}/baseData/S/warehouseManage",
	 		saveUrl:"${pageContext.request.contextPath}/baseData/M/warehouseManage?type=C",
	 		updateUrl:"${pageContext.request.contextPath}/baseData/M/warehouseManage?type=U"
	 	});
	   ...
	   function modifystatus(id,status){
		   $.ajax({
			   url:"${pageContext.request.contextPath}/baseData/M/warehouseManage?type=D",
			   data:{
				   id:id,
				   wareflag:status
			   },
