...
<div class="easyui-layout" fit="true" border="false">
    ...
    <script type="text/javascript">      	
	   ...
	   $("#dg").edatagrid({
	 		url:"${pageContext.request.contextPath}/baseData/S/partCategoryManage",
	 		saveUrl:"${pageContext.request.contextPath}/baseData/M/partCategoryManage?type=C",
	 		updateUrl:"${pageContext.request.contextPath}/baseData/M/partCategoryManage?type=U"
	 	});
	   ...
	   function modifystatus(id,status){
		   $.ajax({
			   url:"${pageContext.request.contextPath}/baseData/M/partCategoryManage?type=D",
			   data:{
				   id:id,
				   partcatflag:status
			   },
