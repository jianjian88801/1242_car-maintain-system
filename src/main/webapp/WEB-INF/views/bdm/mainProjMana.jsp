...
<div class="easyui-layout" fit="true" border="false">
    <div region="center" border="false">
        <table id="dgmainitem" title="维修项目" class="easyui-datagrid"
					fit="true"
					fitColumns="true"
					url="${pageContext.request.contextPath}/baseData/queryAllMainItem" toolbar="#toolbar2"
    ...
    <script type="text/javascript"> 
    	 ...
    	 function changemainitem(id,value){
	   		 $.ajax({
	  			  url:"${pageContext.request.contextPath}/baseData/modifyMainitem?type=D",
	  			  type:"post",
	  			  dataType:"json",
	  			  data:{
	  				  id:id,
    	 ...
    	 function newMainItem(){
    		 ...
    		 combox();
    		 mainitemurl = '${pageContext.request.contextPath}/baseData/modifyMainitem?type=C' ;
    	 ...
    	 function combox(){
    		  // 维系项目类别
	   		   $("#projcategoryid").combobox({
	   			    url:'${pageContext.request.contextPath}/vehicle/mainprojrecord/gtCT',
	   			    valueField:'id',
	   			    textField:'projname',
	   			    readOnly:true
	   		   }); 
    	 ...
    	 function editMainItem(){
    		 ...
    		 if(row==null){
    			 ...
    			 combox();
    			 // 设置路径
    			 mainitemurl = '${pageContext.request.contextPath}/baseData/modifyMainitem?type=U&id='+row.mainitemid;
