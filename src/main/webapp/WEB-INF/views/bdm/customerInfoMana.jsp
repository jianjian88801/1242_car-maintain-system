...
<div class="easyui-layout" fit="true" border="false">
    <div region="center" border="false">
        <table fit="true" id="dg" class="easyui-datagrid" title="客户资料管理" iconCls="icon-shield"
               ...
               url="${pageContext.request.contextPath}/baseData/queryPagedCustomerView"
    ...
    <script type="text/javascript"> 
    	...
    	// 导出excel
    	function toExcel(){
    		window.location.href="${pageContext.request.contextPath}/baseData/toCusttomerExcel";
    	}
    	...
    	function suresubmit(){ 
    		...
    		$('#customerfm').form('submit', {
    			url:"${pageContext.request.contextPath}/baseData/modifyCustomer",
    			onSubmit: function(){
