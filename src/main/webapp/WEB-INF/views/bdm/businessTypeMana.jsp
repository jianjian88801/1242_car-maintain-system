...
<div class="easyui-layout" fit="true" border="false">
    <div region="center" border="false">
       	<table id="dgcategory" title="维修项目大类" class="easyui-datagrid"
					fit="true"
					fitColumns="true"
					url="${pageContext.request.contextPath}/baseData/queryAllProjCategory" toolbar="#toolbar1"
    ...
    <script type="text/javascript">  
    	 ...
    	 function changeCategory(id,value){
	   		 $.ajax({
	  			  url:"${pageContext.request.contextPath}/baseData/modifyPartCategory?type=D",
	  			  type:"post",
	  			  dataType:"json",
	  			  data:{
	  				  id:id,
    	 ...
    	 function newProjCatgory(){
    		 ...
    		 categoryurl = '${pageContext.request.contextPath}/baseData/modifyPartCategory?type=C';
    	 ...
    	 function editProjCatgory(){
    		 ...
    		 if(row==null){
    			 ...
    			 categoryurl = '${pageContext.request.contextPath}/baseData/modifyPartCategory?type=U&id='+row.id;
