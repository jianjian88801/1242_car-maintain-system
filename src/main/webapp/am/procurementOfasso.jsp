...
<div class="easyui-layout" fit="true" border="false">
    <div region="center" border="false">
        <table fit="true" id="dg" class="easyui-datagrid" title="采购配件查询" iconCls="icon-cart_add"
               ...
               fitColumns="true"
               data-options="url:'${pageContext.request.contextPath}/inventory/queryPagedPartProc'"
...
<script>
	...
	function toexcel(){
		...
		let starttime = $("#ds").datebox("getValue");
		let endtime = $("#de").datebox("getValue");
		window.location.href="${pageContext.request.contextPath}/inventory/toPartProcExcel?purchstatus="+status+"&starttime="+starttime+"&endtime="+endtime;
	}
	
	// 确定采购
	function surecaigou(){
		$("#fmcaigou").form('submit', {
			url:"${pageContext.request.contextPath}/inventory/procpart",
			onSubmit: function(){
