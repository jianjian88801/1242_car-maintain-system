...
<script> 
    ...
    require(
            ...
            function (ec) {
                ...
                /////////////////// 第一个图表////////////////
                $.ajax({
                	url:"<%=request.getContextPath()%>/financial/jiedanliang",
                	type:"post",
                	dataType:"json"
                ...
                ////////////////第二个图表//////////////////
                $.ajax({
                	url:"<%=request.getContextPath()%>/financial/yinxiaoe",
                	type:"post",
                	dataType:"json"
                }).done(function(data){
                	var mydata = data;
                ...
                ////////////////第三个图表//////////////////
                $.ajax({
                	url:"<%=request.getContextPath()%>/financial/caigoujine",
                	type:"post",
                	dataType:"json"
                }).done(function(data){
                	var mydata = data;
				...
				////////////////第四个图表//////////////////
                $.ajax({
                	url:"<%=request.getContextPath()%>/financial/zhanbi",
                	type:"post",
                	dataType:"json"
                }).done(function(data){
                	var mydata = data;
