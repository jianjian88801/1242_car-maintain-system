...
import com.xunmaw.car.maintain.entity.*;
import com.xunmaw.car.maintain.service.impl.ServiceFactory;
import com.xunmaw.car.maintain.utils.BaseController;
import com.xunmaw.car.maintain.utils.MyWebUtils;
import com.xunmaw.car.maintain.utils.XLS;
...
public class BaseDataController extends BaseController {
	...
	@ResponseBody
	public String queryallComment() {
		return responseArraySuccess(serviceFactory.getBaseDataManageService().queryComment());
	}
	/**
	 * 查询所有的用户
	 *
	...
	public String queryUser() {
		return responseArraySuccess(serviceFactory.getBaseDataManageService().queryAllUser());
	}
	...
	public String addComment(HttpServletRequest request) {
		...
		try {
			...
			JSONObject resq_jsonObject = JSONObject.parseObject(responseStrBuilder.toString());

			int uid = resq_jsonObject.getIntValue("uid");
			String user_comment = resq_jsonObject.getString("comment");
			String username = resq_jsonObject.getString("username");
			Comment comment = new Comment();
			comment.setComment(user_comment);
			comment.setUserid(uid);
			comment.setUsername(username);
			serviceFactory.getBaseDataManageService().insertComment(comment);

			String param= resq_jsonObject.toJSONString();
